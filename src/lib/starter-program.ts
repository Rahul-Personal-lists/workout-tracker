  ...
  days: [
    {
      ...
      exercises: [
        ...
        { name: "Seated DB Overhead Press", sets: 3, base_reps: 8,  increment: 5,   start_weight: 40,   tracked: true,  image_url: IMG("Seated_Dumbbell_Press") },
...
const PRESET_FULL_BODY_3X_6WK: StarterProgram = {
  ...
  days: [
    ...
    },
    {
      ...
      exercises: [
        { name: "Barbell Back Squat",        sets: 3, base_reps: 5,  increment: 10,  start_weight: 60, tracked: true,  image_url: IMG("Barbell_Squat") },
        { name: "Seated DB Overhead Press",  sets: 3, base_reps: 8,  increment: 5,   start_weight: 35, tracked: true,  image_url: IMG("Seated_Dumbbell_Press") },
        { name: "Romanian Deadlift",         sets: 3, base_reps: 8,  increment: 10,  start_weight: 70, tracked: true,  image_url: IMG("Romanian_Deadlift") },
      ],
    },
    {
