...
export function BottomNav() {
  ...
  if (pathname === "/program/edit" || pathname.startsWith("/workout/")) return null;
          ...
          return (
            <li key={href} className="flex">
              <Link
                ...
                className={cn(
                  "relative flex-1 flex flex-col items-center justify-center gap-1 text-[11px] outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus-ring-color)] focus-visible:ring-offset-2 focus-visible:ring-offset-background",
